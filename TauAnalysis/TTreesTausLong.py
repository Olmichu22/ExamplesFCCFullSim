...
filename = "Tree_"+ general_configs["fileOutName"]
fileOutName=os.path.join(general_configs["outputpath"], filename)
...
RecoTauConstKey = ROOT.std.vector('int')()  # Permite identificar a que Tau pertenece el constituyente
